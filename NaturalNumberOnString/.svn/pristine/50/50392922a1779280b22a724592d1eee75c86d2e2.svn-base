 ...
 * </pre>
 *
 * @author Arnav Muley & Steven Harrison
 *
 */
public class NaturalNumber3 extends NaturalNumberSecondary {
    ...
    public final void multiplyBy10(int k) {
        ...
        //updated ur code with the leading zeroes problem
    ...
    public final int divideBy10() {
         ...
         * int remainder = 0;
         *
         * char[] arrString = this.rep.toCharArray(); for (char character :
         * arrString) { if (!(character == arrString[arrString.length])) {
         *
         * } }
         */
        ...
        int remainder = 0;
        if (!this.rep.isEmpty()) {
            String remainderString = this.rep.substring(this.rep.length() - 1);
